...
export default function Privacy() {
  //A formatted generic privacy policy
  //Privacy poliy was help made by
    ...
    <>
      ...
      <div className="container">
        <div className={styles.customContainer}>
          <h1>Privacy Policy for Festival Conductor</h1>

          <p>
            At festivalconductormaine.io, accessible from
            festivalconductormaine.io, one of our main priorities is the privacy
            of our visitors. This Privacy Policy document contains types of
            information that is collected and recorded by
            festivalconductormaine.io and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in festivalconductormaine.io. This
          ...
          <p>
            festivalconductormaine.io follows a standard procedure of using log
          ...
          <p>
            Like any other website, festivalconductormaine.io uses
          ...
          <p>
            ...
            advertising partners of festivalconductormaine.io.
          </p>
          ...
          <p>
            ...
            festivalconductormaine.io, which are sent directly to users`&apos;`
          ...
          <p>
            Note that festivalconductormaine.io has no access to or control over
          ...
          <p>
            festivalconductormaine.io`&apos;`s Privacy Policy does not apply to
          ...
          <p>
            festivalconductormaine.io does not knowingly collect any Personal
